<?php
    ...
    $owner_id = $_SESSION['user_id']; // Assuming owner ID is stored in session
    $bookings_sql = "SELECT b.*, u.name AS user_name, u.email AS user_email, b.proof_of_payment
                    FROM bookings b 
                    JOIN users u ON b.user_id = u.user_id 
                    WHERE b.hostel_id = (SELECT hostel_id FROM hostels WHERE owner_id = ?)";
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div style="margin-top: 81px;">
            <ul>
                ...
                <li><a href="hostels-management.php"><i class="fas fa-building"></i><span class="link-text">Manage Hostels owners</span></a></li>
