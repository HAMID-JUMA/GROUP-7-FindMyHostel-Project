    ...
    <div class="main-content" id="main-content">
            ...
            <table id="studentTable">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>1</td>
                        <td>gareth chimimba</td>
                        <td>gare@example.com</td>
                        <td>0998276461</td>
                        <td>Introverts</td>
                        <td>Introverts</td>
                        <td>Goliat</td>
        ...
        <div id="editModal" class="modal">
            <div class="modal-content">
                ...
                <h2>Edit Owner</h2>
                <form id="editForm">
                    <label for="studentId">Owner ID:</label>
                    ...
                    <br>
                    <label for="studentCourse">Contact:</label>
                    <input type="text" id="studentCourse" name="studentCourse" required>
                    <br>
                    <label for="hostelStatus">Hostel name</label>
                    <input type="text" id="hostelStatus" name="hostelStatus" required>
                    <br>
                    <label for="applicationStatus">location</label>
        ...
        <script>
            ...
            function editStudent(id, name, email, course, hostelStatus, applicationStatus) {
                ...
                document.getElementById("ownerContact").value = course;
                document.getElementById("hostelName").value = hostelStatus;
                document.getElementById("hostelLocation").value = applicationStatus;
